...
struct qt_meta_stringdata_RS_ActionModifyEntity_t {
    QByteArrayData data[1];
    char stringdata0[22];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_RS_ActionModifyEntity_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_RS_ActionModifyEntity_t qt_meta_stringdata_RS_ActionModifyEntity = {
    {
QT_MOC_LITERAL(0, 0, 21) // "RS_ActionModifyEntity"
...
QT_INIT_METAOBJECT const QMetaObject RS_ActionModifyEntity::staticMetaObject = { {
    QMetaObject::SuperData::link<RS_ActionInterface::staticMetaObject>(),
    qt_meta_stringdata_RS_ActionModifyEntity.data,
    qt_meta_data_RS_ActionModifyEntity,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *RS_ActionModifyEntity::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_RS_ActionModifyEntity.stringdata0))
