...
struct qt_meta_stringdata_RS_ActionDrawLineAngle_t {
    QByteArrayData data[1];
    char stringdata0[23];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_RS_ActionDrawLineAngle_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_RS_ActionDrawLineAngle_t qt_meta_stringdata_RS_ActionDrawLineAngle = {
    {
QT_MOC_LITERAL(0, 0, 22) // "RS_ActionDrawLineAngle"
...
QT_INIT_METAOBJECT const QMetaObject RS_ActionDrawLineAngle::staticMetaObject = { {
    QMetaObject::SuperData::link<RS_PreviewActionInterface::staticMetaObject>(),
    qt_meta_stringdata_RS_ActionDrawLineAngle.data,
    qt_meta_data_RS_ActionDrawLineAngle,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *RS_ActionDrawLineAngle::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_RS_ActionDrawLineAngle.stringdata0))
