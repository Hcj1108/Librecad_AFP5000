...
struct qt_meta_stringdata_QC_ActionGetSelect_t {
    QByteArrayData data[1];
    char stringdata0[19];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QC_ActionGetSelect_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QC_ActionGetSelect_t qt_meta_stringdata_QC_ActionGetSelect = {
    {
QT_MOC_LITERAL(0, 0, 18) // "QC_ActionGetSelect"
...
QT_INIT_METAOBJECT const QMetaObject QC_ActionGetSelect::staticMetaObject = { {
    QMetaObject::SuperData::link<RS_ActionInterface::staticMetaObject>(),
    qt_meta_stringdata_QC_ActionGetSelect.data,
    qt_meta_data_QC_ActionGetSelect,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *QC_ActionGetSelect::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QC_ActionGetSelect.stringdata0))
