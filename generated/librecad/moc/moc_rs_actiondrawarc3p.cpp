...
struct qt_meta_stringdata_RS_ActionDrawArc3P_t {
    QByteArrayData data[1];
    char stringdata0[19];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_RS_ActionDrawArc3P_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_RS_ActionDrawArc3P_t qt_meta_stringdata_RS_ActionDrawArc3P = {
    {
QT_MOC_LITERAL(0, 0, 18) // "RS_ActionDrawArc3P"
...
QT_INIT_METAOBJECT const QMetaObject RS_ActionDrawArc3P::staticMetaObject = { {
    QMetaObject::SuperData::link<RS_PreviewActionInterface::staticMetaObject>(),
    qt_meta_stringdata_RS_ActionDrawArc3P.data,
    qt_meta_data_RS_ActionDrawArc3P,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *RS_ActionDrawArc3P::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_RS_ActionDrawArc3P.stringdata0))
