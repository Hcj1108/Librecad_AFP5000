...
struct qt_meta_stringdata_RS_ActionFileNewTemplate_t {
    QByteArrayData data[1];
    char stringdata0[25];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_RS_ActionFileNewTemplate_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_RS_ActionFileNewTemplate_t qt_meta_stringdata_RS_ActionFileNewTemplate = {
    {
QT_MOC_LITERAL(0, 0, 24) // "RS_ActionFileNewTemplate"
...
QT_INIT_METAOBJECT const QMetaObject RS_ActionFileNewTemplate::staticMetaObject = { {
    QMetaObject::SuperData::link<RS_ActionInterface::staticMetaObject>(),
    qt_meta_stringdata_RS_ActionFileNewTemplate.data,
    qt_meta_data_RS_ActionFileNewTemplate,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *RS_ActionFileNewTemplate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_RS_ActionFileNewTemplate.stringdata0))
