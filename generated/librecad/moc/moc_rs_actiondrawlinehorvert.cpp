...
struct qt_meta_stringdata_RS_ActionDrawLineHorVert_t {
    QByteArrayData data[1];
    char stringdata0[25];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_RS_ActionDrawLineHorVert_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_RS_ActionDrawLineHorVert_t qt_meta_stringdata_RS_ActionDrawLineHorVert = {
    {
QT_MOC_LITERAL(0, 0, 24) // "RS_ActionDrawLineHorVert"
...
QT_INIT_METAOBJECT const QMetaObject RS_ActionDrawLineHorVert::staticMetaObject = { {
    QMetaObject::SuperData::link<RS_PreviewActionInterface::staticMetaObject>(),
    qt_meta_stringdata_RS_ActionDrawLineHorVert.data,
    qt_meta_data_RS_ActionDrawLineHorVert,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *RS_ActionDrawLineHorVert::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_RS_ActionDrawLineHorVert.stringdata0))
