...
struct qt_meta_stringdata_RS_ActionDimRadial_t {
    QByteArrayData data[1];
    char stringdata0[19];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_RS_ActionDimRadial_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_RS_ActionDimRadial_t qt_meta_stringdata_RS_ActionDimRadial = {
    {
QT_MOC_LITERAL(0, 0, 18) // "RS_ActionDimRadial"
...
QT_INIT_METAOBJECT const QMetaObject RS_ActionDimRadial::staticMetaObject = { {
    QMetaObject::SuperData::link<RS_ActionDimension::staticMetaObject>(),
    qt_meta_stringdata_RS_ActionDimRadial.data,
    qt_meta_data_RS_ActionDimRadial,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *RS_ActionDimRadial::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_RS_ActionDimRadial.stringdata0))
