...
struct qt_meta_stringdata_QG_LibraryInsertOptions_t {
    QByteArrayData data[8];
    char stringdata0[90];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QG_LibraryInsertOptions_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QG_LibraryInsertOptions_t qt_meta_stringdata_QG_LibraryInsertOptions = {
    {
QT_MOC_LITERAL(0, 0, 23), // "QG_LibraryInsertOptions"
...
QT_MOC_LITERAL(6, 64, 10), // "updateData"
QT_MOC_LITERAL(7, 75, 14) // "languageChange"

    },
    "QG_LibraryInsertOptions\0setAction\0\0"
...
void QG_LibraryInsertOptions::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QG_LibraryInsertOptions *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject QG_LibraryInsertOptions::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_QG_LibraryInsertOptions.data,
    qt_meta_data_QG_LibraryInsertOptions,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *QG_LibraryInsertOptions::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QG_LibraryInsertOptions.stringdata0))
