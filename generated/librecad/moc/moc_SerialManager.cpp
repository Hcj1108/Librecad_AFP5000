...
#include <memory>
#include "../../../librecad/src/OCRdemo/SerialManager.h"
...
QT_MOC_LITERAL(3, 24, 12), // "setzhuangtai"
QT_MOC_LITERAL(4, 37, 6) // "SendNG"

    },
    "SerialManager\0showmain\0\0setzhuangtai\0"
    "SendNG"
};
...
void SerialManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->setzhuangtai(); break;
        case 2: _t->SendNG(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialManager::showmain)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SerialManager::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialManager::setzhuangtai)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (SerialManager::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialManager::SendNG)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void SerialManager::showmain()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void SerialManager::setzhuangtai()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void SerialManager::SendNG()
{
