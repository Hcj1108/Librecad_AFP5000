...
struct qt_meta_stringdata_RS_ActionSelectContour_t {
    QByteArrayData data[1];
    char stringdata0[23];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_RS_ActionSelectContour_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_RS_ActionSelectContour_t qt_meta_stringdata_RS_ActionSelectContour = {
    {
QT_MOC_LITERAL(0, 0, 22) // "RS_ActionSelectContour"
...
QT_INIT_METAOBJECT const QMetaObject RS_ActionSelectContour::staticMetaObject = { {
    QMetaObject::SuperData::link<RS_ActionInterface::staticMetaObject>(),
    qt_meta_stringdata_RS_ActionSelectContour.data,
    qt_meta_data_RS_ActionSelectContour,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *RS_ActionSelectContour::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_RS_ActionSelectContour.stringdata0))
