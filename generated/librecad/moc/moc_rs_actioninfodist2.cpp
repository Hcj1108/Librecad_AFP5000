...
struct qt_meta_stringdata_RS_ActionInfoDist2_t {
    QByteArrayData data[1];
    char stringdata0[19];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_RS_ActionInfoDist2_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_RS_ActionInfoDist2_t qt_meta_stringdata_RS_ActionInfoDist2 = {
    {
QT_MOC_LITERAL(0, 0, 18) // "RS_ActionInfoDist2"
...
QT_INIT_METAOBJECT const QMetaObject RS_ActionInfoDist2::staticMetaObject = { {
    QMetaObject::SuperData::link<RS_PreviewActionInterface::staticMetaObject>(),
    qt_meta_stringdata_RS_ActionInfoDist2.data,
    qt_meta_data_RS_ActionInfoDist2,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *RS_ActionInfoDist2::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_RS_ActionInfoDist2.stringdata0))
