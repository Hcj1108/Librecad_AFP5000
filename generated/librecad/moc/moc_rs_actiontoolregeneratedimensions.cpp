...
struct qt_meta_stringdata_RS_ActionToolRegenerateDimensions_t {
    QByteArrayData data[1];
    char stringdata0[34];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_RS_ActionToolRegenerateDimensions_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_RS_ActionToolRegenerateDimensions_t qt_meta_stringdata_RS_ActionToolRegenerateDimensions = {
    {
QT_MOC_LITERAL(0, 0, 33) // "RS_ActionToolRegenerateDimens..."
...
QT_INIT_METAOBJECT const QMetaObject RS_ActionToolRegenerateDimensions::staticMetaObject = { {
    QMetaObject::SuperData::link<RS_ActionInterface::staticMetaObject>(),
    qt_meta_stringdata_RS_ActionToolRegenerateDimensions.data,
    qt_meta_data_RS_ActionToolRegenerateDimensions,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *RS_ActionToolRegenerateDimensions::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_RS_ActionToolRegenerateDimensions.stringdata0))
