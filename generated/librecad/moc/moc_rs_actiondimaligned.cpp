...
struct qt_meta_stringdata_RS_ActionDimAligned_t {
    QByteArrayData data[1];
    char stringdata0[20];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_RS_ActionDimAligned_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_RS_ActionDimAligned_t qt_meta_stringdata_RS_ActionDimAligned = {
    {
QT_MOC_LITERAL(0, 0, 19) // "RS_ActionDimAligned"
...
QT_INIT_METAOBJECT const QMetaObject RS_ActionDimAligned::staticMetaObject = { {
    QMetaObject::SuperData::link<RS_ActionDimension::staticMetaObject>(),
    qt_meta_stringdata_RS_ActionDimAligned.data,
    qt_meta_data_RS_ActionDimAligned,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *RS_ActionDimAligned::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_RS_ActionDimAligned.stringdata0))
