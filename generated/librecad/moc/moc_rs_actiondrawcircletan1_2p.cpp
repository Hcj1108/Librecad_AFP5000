...
struct qt_meta_stringdata_RS_ActionDrawCircleTan1_2P_t {
    QByteArrayData data[1];
    char stringdata0[27];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_RS_ActionDrawCircleTan1_2P_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_RS_ActionDrawCircleTan1_2P_t qt_meta_stringdata_RS_ActionDrawCircleTan1_2P = {
    {
QT_MOC_LITERAL(0, 0, 26) // "RS_ActionDrawCircleTan1_2P"
...
QT_INIT_METAOBJECT const QMetaObject RS_ActionDrawCircleTan1_2P::staticMetaObject = { {
    QMetaObject::SuperData::link<RS_PreviewActionInterface::staticMetaObject>(),
    qt_meta_stringdata_RS_ActionDrawCircleTan1_2P.data,
    qt_meta_data_RS_ActionDrawCircleTan1_2P,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *RS_ActionDrawCircleTan1_2P::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_RS_ActionDrawCircleTan1_2P.stringdata0))
