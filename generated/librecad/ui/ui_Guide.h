...
public:
    ...
    void setupUi(QWidget *GuideClass)
    {
        ...
        verticalLayout = new QVBoxLayout(GuideClass);
...
"border: 2px solid #27ae60;"));
        ...
        pushButton = new QPushButton(GuideClass);
...
"QPushButton:hover{background: #2980b9;}"));
        ...
        pushButton_3 = new QPushButton(GuideClass);
...
"QPushButton:hover{background: #e67e22;}"));
        ...
        pushButton_4 = new QPushButton(GuideClass);
...
"QPushButton:hover{background: #7f8c8d;}"));
        ...
        pushButton_5 = new QPushButton(GuideClass);
...
"QPushButton:hover{background: #7f8c8d;}"));
        ...
        pushButton_6 = new QPushButton(GuideClass);
...
"QPushButton:hover{background: #229954;}"));
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/PIC/Resources/PICs/Wenjian.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        horizontalLayout_2->addItem(spacerBtn);

        pushButton_2 = new QPushButton(GuideClass);
        pushButton_2->setObjectName(QString::fromUtf8("pushButton_2"));
        pushButton_2->setMinimumSize(QSize(80, 36));
        pushButton_2->setMaximumSize(QSize(80, 36));
        pushButton_2->setStyleSheet(QString::fromUtf8("QPushButton{font: bold 12px \"Microsoft YaHei\"; background: #e74c3c; color: white; border-radius: 6px; padding: 6px 14px;}\n"
"QPushButton:hover{background: #c0392b;}"));
    ...
    void retranslateUi(QWidget *GuideClass)
    {
        ...
        pushButton_4->setText(QCoreApplication::translate("GuideClass", "\345\233\236\351\200\2005s", nullptr));
        pushButton_5->setText(QCoreApplication::translate("GuideClass", "\345\277\253\350\277\2335s", nullptr));
        pushButton_6->setText(QCoreApplication::translate("GuideClass", "\346\225\231\347\250\213\346\226\207\346\241\243", nullptr));
        pushButton_2->setText(QCoreApplication::translate("GuideClass", "\345\205\263\351\227\255", nullptr));
    } // retranslateUi
