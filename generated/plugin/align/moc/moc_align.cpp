...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_LC_Align_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_LC_Align_t qt_meta_stringdata_LC_Align = {
    {
QT_MOC_LITERAL(0, 0, 8) // "LC_Align"
...
QT_INIT_METAOBJECT const QMetaObject LC_Align::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_LC_Align.data,
    qt_meta_data_LC_Align,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *LC_Align::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LC_Align.stringdata0))
