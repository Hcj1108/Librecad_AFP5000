...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_LC_SameProp_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_LC_SameProp_t qt_meta_stringdata_LC_SameProp = {
    {
QT_MOC_LITERAL(0, 0, 11) // "LC_SameProp"
...
QT_INIT_METAOBJECT const QMetaObject LC_SameProp::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_LC_SameProp.data,
    qt_meta_data_LC_SameProp,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *LC_SameProp::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LC_SameProp.stringdata0))
