...
void QG_DlgText::updateText() {
    if (text) {
        ...
        QString userText = teText->text();
       // if (userText.contains("{DATE}")) {
       //     userText.replace("{DATE}", QDate::currentDate().toString("yyyy-MM-dd"));
       // }
        text->setText(userText);
       // qDebug() << "原始文本:" << teText->text();
       // qDebug() << "替换后文本:" << userText;
