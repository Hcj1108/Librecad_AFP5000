...
void QG_ExitDialog::init()
{
    ...
    ui->buttonBox->button(QDialogButtonBox::Save)->setText(QString::fromLocal8Bit("保存"));
    ui->buttonBox->button(QDialogButtonBox::SaveAll)->setText(QString::fromLocal8Bit("全部保存"));
...
void QG_ExitDialog::setShowSaveAll(bool show)
{
    ...
    QString close = show ? QString::fromLocal8Bit("全部关闭") : QString::fromLocal8Bit("关闭");
