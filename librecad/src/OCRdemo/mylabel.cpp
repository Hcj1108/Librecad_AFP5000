...
void MyLabel::paintEvent(QPaintEvent* event)
{
	...
	QString strPoint = QString(QString::fromLocal8Bit("X轴: ") + " %0, " + QString::fromLocal8Bit("Y轴: ") + "%1").arg(m_roiRect.x()).arg(m_roiRect.y());           //位置信息
	QString strSize = QString(QString::fromLocal8Bit("宽度: ") + "%0," + QString::fromLocal8Bit("高度: ") + "%1").arg(m_roiRect.width()).arg(m_roiRect.height());   //大小信息
	...
	QPainter painter;
	painter.begin(this);
	painter.setBrush(QBrush(QColor(0, 0, 100, 30)));
	painter.setPen(pen);
